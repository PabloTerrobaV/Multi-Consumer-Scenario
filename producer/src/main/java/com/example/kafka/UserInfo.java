...
public class UserInfo extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5242024472091002752L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserInfo\",\"namespace\":\"com.example.kafka\",\"fields\":[{\"name\":\"userId\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"age\",\"type\":[\"null\",\"int\"],\"default\":null},{\"name\":\"phone\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"dni\",\"type\":\"long\",\"default\":0},{\"name\":\"email\",\"type\":\"string\"}]}");
   ...
   */
  public UserInfo(java.lang.CharSequence userId, java.lang.CharSequence name, java.lang.Integer age, java.lang.Long phone, java.lang.Long dni, java.lang.CharSequence email) {
    this.userId = userId;
    this.name = name;
    this.age = age;
    this.phone = phone;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: dni = (java.lang.Long)value$; break;
   ...
   */
  public static com.example.kafka.UserInfo.Builder newBuilder() {
    return new com.example.kafka.UserInfo.Builder();
  }
   ...
   * @return A new UserInfo RecordBuilder
   */
  public static com.example.kafka.UserInfo.Builder newBuilder(com.example.kafka.UserInfo.Builder other) {
    if (other == null) {
      return new com.example.kafka.UserInfo.Builder();
    } else {
      return new com.example.kafka.UserInfo.Builder(other);
    }
  }
   ...
   * @return A new UserInfo RecordBuilder
   */
  public static com.example.kafka.UserInfo.Builder newBuilder(com.example.kafka.UserInfo other) {
    if (other == null) {
      return new com.example.kafka.UserInfo.Builder();
    } else {
      return new com.example.kafka.UserInfo.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserInfo>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.kafka.UserInfo.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[4], other.dni)) {
        this.dni = data().deepCopy(fields()[4].schema(), other.dni);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.kafka.UserInfo other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.UserInfo.Builder setUserId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.UserInfo.Builder clearUserId() {
      userId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.UserInfo.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.UserInfo.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.UserInfo.Builder setAge(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.UserInfo.Builder clearAge() {
      age = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.UserInfo.Builder setPhone(java.lang.Long value) {
    ...
    public UserInfo build() {
      try {
        ...
        record.dni = fieldSetFlags()[4] ? this.dni : (java.lang.Long) defaultValue(fields()[4]);
